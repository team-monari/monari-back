...
INSERT INTO study (title, description, subject, school_level, status, student_id, location_id, general_location_id,
                   ...
                   updated_at,
                   region, study_type)
VALUES ('고등수학 스터디 - 미적분 문제풀이', '매주 모여 미적분 심화 문제를 함께 풀이합니다.', 'MATH', 'HIGH', 'ACTIVE', 1, null, null,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'GEUMCHEON_GU', 'ONLINE'),
       ('물리 스터디 - 역학 집중 탐구', '뉴턴 역학 중심으로 개념 이해 및 문제 해결 능력 향상.', 'SCIENCE', 'HIGH', 'ACTIVE', 2, null, 2,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'GEUMCHEON_GU', 'OFFLINE'),
       ('중학수학 내신 대비 스터디', '학교 시험 범위 맞춰 개념 정리 및 문제 풀이 진행.', 'MATH', 'MIDDLE', 'CLOSED', 3, 4, null,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'GANGBUK_GU', 'OFFLINE'),
       ('화학 반응식 완전 정복', '다양한 화학 반응식을 이해하고 암기하는 스터디.', 'SCIENCE', 'HIGH', 'ACTIVE', 7, null, 8,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MAPO_GU', 'OFFLINE'),
       ('생명과학 토론 스터디', '최신 생명과학 이슈에 대해 토론하고 발표합니다.', 'SCIENCE', 'HIGH', 'ACTIVE', 9, 6, null,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MAPO_GU', 'OFFLINE'),
       ('확률과 통계 개념 완성', '확률과 통계 기본 개념부터 응용까지 함께 공부합니다.', 'MATH', 'HIGH', 'ACTIVE', 5, null, 1,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SEOCHO_GU', 'OFFLINE'),
...
VALUES
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1, 'PENDING'),
    ...
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 5, 4, 'PENDING'),
    ...
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 9, 1, 'PENDING'),
